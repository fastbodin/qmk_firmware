...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LGUI(KC_DLR),   LCTL(KC_L),     LSFT(KC_TAB),   KC_NO,          KC_NO,                      KC_NO,          KC_NO,          KC_VOLD,        KC_VOLU,        KC_NO,
    KC_ENT,         LCTL(KC_Y),     KC_TAB,         KC_TRNS,        KC_NO,                      KC_LEFT,        KC_DOWN,        KC_UP,          KC_RGHT,        KC_ENT,
    KC_NO,          LCTL(KC_H),     KC_NO,          KC_NO,          KC_NO,                      KC_NO,          KC_NO,          KC_BRID,        KC_BRIU,        KC_NO,
                                    KC_LGUI,        KC_LSFT,        KC_BSPC,                    KC_SPC,         KC_NO,          KC_RCTL
    ),
